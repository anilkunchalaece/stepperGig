...
#    for example <STEPPER1,200>
#    this means set the STEPPE value is 200
#      
...
import serial
import time
import openpyxl #excel Module for Python 

print
print

#Please chaneg the workbook name and Shee name to your Specific
wb= openpyxl.load_workbook('testfile.xlsx')
sheet=wb.get_sheet_by_name('Sheet1')
#load the data into the List
testData = []
for y in range(1,sheet.max_row+1):
				testData.append("<"+"STEPPER1,"+str(sheet.cell(row=y,column=1).value)+">")
